...
cltv_final.to_sql(name='cltv_prediction_dsmlbc6', con=conn, if_exists='replace', index=False)



pd.read_sql_query("select * from cltv_prediction_dsmlbc6 limit 10", conn)
...
rfm_final.to_sql(name='rfm_final_dsmlbc6', con=conn, if_exists='replace', index=False)
